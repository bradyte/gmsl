...
logging.info('Write SLEEP = 1 to local device.')
gmsl2_ser.register_write(0x0010, 0x19)  # Write SLEEP = 1 to local device.
...
logging.info('Write SLEEP = 0 to local device.')
gmsl2_ser.register_write(0x0010, 0x51)  # Write SLEEP = 0 to local device.
